...
- [ofekron/better-agent](https://github.com/ofekron/better-agent) - Local, inspectable workspace for persistent Codex, Claude, and Gemini coding-agent workflows, with session orchestration, delegation, forks, and an integration SDK.
